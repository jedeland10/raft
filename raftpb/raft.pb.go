...
type Entry struct {
	...
	EncodableFields map[uint32]bool `protobuf:"bytes,5,rep,name=EncodableFields" json:"EncodableFields,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
}
...
func init() {
	...
	proto.RegisterMapType((map[uint32]bool)(nil), "raftpb.Entry.EncodableFieldsEntry")
...
var fileDescriptor_b042552c306ae59b = []byte{
	...
	,
}
...
func (m *Entry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.EncodableFields) > 0 {
		for k := range m.EncodableFields {
			v := m.EncodableFields[k]
			baseI := i
			i--
			if v {
				dAtA[i] = 1
...
func (m *Entry) Size() (n int) {
	...
	if len(m.EncodableFields) > 0 {
		for k, v := range m.EncodableFields {
			_ = k
			_ = v
...
func (m *Entry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncodableFields", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.EncodableFields == nil {
				m.EncodableFields = make(map[uint32]bool)
			}
			var mapkey uint32
			var mapvalue bool
			for iNdEx < postIndex {
			...
			m.EncodableFields[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRaft(dAtA[iNdEx:])
